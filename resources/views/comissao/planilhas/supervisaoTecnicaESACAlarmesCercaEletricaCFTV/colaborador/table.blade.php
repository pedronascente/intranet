            ...
            @if ($listaComissao)
                @foreach ($listaComissao as $comissao)
                    <tr>
                        ...
                        <td>
                            <x-botao.btn-editar :rota="route('stsace-cftv.edit', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                            <x-botao.btn-excluir :rota="route('stsace-cftv.destroy', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                        </td>
                    </tr>
                @endforeach
            @endif
