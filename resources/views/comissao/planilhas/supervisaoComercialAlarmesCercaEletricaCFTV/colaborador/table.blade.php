            ...
            @if ($listaComissao)
                @foreach ($listaComissao as $comissao)
                    <tr>
                        ...
                        <td>
                            <x-botao.btn-editar :rota="route('supervisao-cace-cftv.edit', $comissao->id)"/>
                            <x-botao.btn-excluir :rota="route('supervisao-cace-cftv.destroy', $comissao->id)" titulo="Excluir Comissão" />
                        </td>
                    </tr>
                @endforeach
            @endif
