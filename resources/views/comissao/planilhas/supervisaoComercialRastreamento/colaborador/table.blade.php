            ...
            @if ($listaComissao)
                @foreach ($listaComissao as $comissao)
                    <tr>
                        ...
                        <td>
                            <x-botao.btn-editar :rota="route('supervisao-c-r.edit', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                            <x-botao.btn-excluir :rota="route('supervisao-c-r.destroy', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                        </td>
                    </tr>
                @endforeach
            @endif
