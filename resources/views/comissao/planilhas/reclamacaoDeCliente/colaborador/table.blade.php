            ...
            @if ($listaComissao)
                @foreach ($listaComissao as $comissao)
                    <tr>
                        ...
                        <td>
                            <x-botao.btn-editar :rota="route('reclamacao-de-cliente.edit', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                            <x-botao.btn-excluir :rota="route('reclamacao-de-cliente.destroy', $comissao->id)" :arrayListPermissoesDoModuloDaRota="$arrayListPermissoesDoModuloDaRota"/>
                        </td>
                    </tr>
                @endforeach
            @endif
