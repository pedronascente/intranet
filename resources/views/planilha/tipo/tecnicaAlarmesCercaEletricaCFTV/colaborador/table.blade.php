            ...
            @if ($listaComissao)
                @foreach ($listaComissao as $comissao)
                    <tr>
                        ...
                        <td>
                            <x-botao.btn-editar :rota="route('tecnica-ace-cftv.edit', $comissao->id)"/>
                            <x-botao.btn-excluir :rota="route('tecnica-ace-cftv.destroy', $comissao->id)" titulo="Excluir Comissão" />
                        </td>
                    </tr>
                @endforeach
            @endif
