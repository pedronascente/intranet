                    ...
                    <div class="col-md-12">
                        @if ($users)
                            <div class="alert alert-info alert-dismissible">
                                ...
                                <i class="icon fas fa-exclamation-triangle"></i>Selecione um usuário abaixo, para ser
                                associado!
                            </div>
                        @else
                            <div class="alert alert-warning alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                <i class="icon fas fa-exclamation-triangle"></i>Todos os usuários já estão associados.
                            </div>
                        @endif
                    </div>
                </div>
