...
class ModuloSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('modulos')->insert(['nome' => 'Lançar Comissão',     'rota' => '/planilha/colaborador',        'slug' => 'lancar-comissao',     'descricao' => "Responsável por lanças as comissões dos colaboradores."]);
        DB::table('modulos')->insert(['nome' => 'Administrar Comissão','rota' => '/planilha-administrativo',     'slug' => 'administrar-comissao','descricao' => "Responsável por Administrar as comissões dos colaboradores."]);
    }
}
